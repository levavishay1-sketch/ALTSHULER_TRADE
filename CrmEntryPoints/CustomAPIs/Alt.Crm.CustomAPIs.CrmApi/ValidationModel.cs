...
namespace Alt.Crm.CustomAPIs.CrmApi
{
    ...
    public partial class ControllersController
    {
        ...
        private ControllersControllerRoute[] routeField;

        private string nameField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Route")]
        public ControllersControllerRoute[] Route
        {
            get
            {
    ...
    public partial class ControllersControllerRoute
    {
        ...
        private ControllersControllerRouteAction[] actionField;

        private string pathField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Action")]
        public ControllersControllerRouteAction[] Action
        {
            get
            {
    ...
    public partial class ControllersControllerRouteAction
    {
        ...
        private ControllersControllerRouteActionSourceSystemValidation[] sourceSystemValidation;

        private string nameField;

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("SourceSystemValidation")]
        public ControllersControllerRouteActionSourceSystemValidation[] SourceSystemValidation
        {
            get
            {
    ...
    public partial class ControllersControllerRouteActionSourceSystemValidation
    {
        ...
        private ControllersControllerRouteActionProperty[] propertyField;
        ...
        public ControllersControllerRouteActionProperty[] Property
        {
            get
            {
    ...
    public partial class ControllersControllerRouteActionProperty
    {
        ...
        private ControllersControllerRouteActionProperty[] innerPropertyField;
        ...
        public ControllersControllerRouteActionProperty[] InnerProperty
        {
            get
            {
