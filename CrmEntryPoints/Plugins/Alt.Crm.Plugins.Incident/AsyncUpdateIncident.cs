...
{
    public class AsyncUpdateIncident : PluginBase
    {
        public AsyncUpdateIncident(string unsecure, string secure) : base(typeof(AsyncUpdateIncident)) { }
        ...
        protected override void ExecuteCrmPlugin(LocalContext localcontext)
        {
            ...
            incidentBl.HandleChildCasesCancellation(targetIncident, preIncident);
        }
    }
}
