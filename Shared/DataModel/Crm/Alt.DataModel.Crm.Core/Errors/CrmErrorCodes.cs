...
namespace Alt.DataModel.Crm.Core.Errors
{
	public sealed class CrmErrorCodes
	{
		...
		public const int ReportRdlSandboxing = unchecked((int)0x80048293); // -2147188077
		public const int SrsDataConnectorNotInstalledUpload = unchecked((int)0x80048292); // -2147188078
		...
		public const int DefaultSiteMapDeleteFailure = unchecked((int)0x80048070); // -2147188624
		...
		public const int GraphApiS2SSetupFailureException = unchecked((int)0x80044260); // -2147204512
		public const int ProvisionRIAccessNotAllowed = unchecked((int)0x80044270); // -2147204496
		public const int InvalidRequestDataFormat = unchecked((int)0x80044271); // -2147204495
		public const int InvalidFeatureType = unchecked((int)0x80044272); // -2147204494
		public const int UpdateRIOrganizationDataAccessNotAllowed = unchecked((int)0x80044273); // -2147204493
		public const int DeprovisionRIAccessNotAllowed = unchecked((int)0x80044274); // -2147204492
		public const int ActivityAnalysisOrganizationUpdateError = unchecked((int)0x80044275); // -2147204491
		public const int RelationshipIntelligenceSDKInvocationError = unchecked((int)0x80044276); // -2147204490
		public const int EnableRIFeatureNotAllowed = unchecked((int)0x80044279); // -2147204487
		public const int DisableRIFeatureNotAllowed = unchecked((int)0x80044280); // -2147204480
		public const int RINotProvisioned = unchecked((int)0x80044281); // -2147204479
		public const int ErrorOnGetRIProvisionStatus = unchecked((int)0x80044282); // -2147204478
		public const int ErrorOnGetRITenantEndPoint = unchecked((int)0x80044283); // -2147204477
		public const int ErrorOnStartOfRIProvision = unchecked((int)0x80044284); // -2147204476
		public const int ErrorOnTenantVerifyUpdate = unchecked((int)0x80044285); // -2147204475
		public const int ErrorOnGetRecord = unchecked((int)0x80044286); // -2147204474
		public const int ErrorOnQryPropertyBagCollection = unchecked((int)0x80044287); // -2147204473
		public const int ErrorPropertyBagCollectionMissedColumn = unchecked((int)0x80044288); // -2147204472
		public const int ErrorOnFeatureStatusChange = unchecked((int)0x80044289); // -2147204471
		public const int ErrorFetchingBaseUrl = unchecked((int)0x80044290); // -2147204464
		public const int ErrorFetchingRIProvisionStatus = unchecked((int)0x80044291); // -2147204463
		public const int RelationshipInsightsFeatureDisableError = unchecked((int)0x80044292); // -2147204462
		public const int RelationshipInsightsFeatureNotEnabledError = unchecked((int)0x80044293); // -2147204461
		...
		public const int CannotUpdateAzureActiveDirectoryObjectIdField = unchecked((int)0x80041d4f); // -2147214001
		...
		public const int GenericAzureActiveDirectoryError = unchecked((int)0x80041d54); // -2147213996
		...
		public const int ApplicationUserAllowCustomRoleOnly = unchecked((int)0x8004f50f); // -2147158769
		public const int AzureApplicationIdNotFound = unchecked((int)0x8004f510); // -2147158768
		public const int DuplicateApplicationUser = unchecked((int)0x8004f511); // -2147158767
		public const int AzureApplicationIdNotFoundInOrgDB = unchecked((int)0x8004f512); // -2147158766
		...
		public const int DuplicateAttributePhysicalName = unchecked((int)0x80060304); // -2147089660
		public const int AttributeIsNotFacetable = unchecked((int)0x80060305); // -2147089659
		public const int ExceededLimitForAllowedFacetableAttributes = unchecked((int)0x80060306); // -2147089658
		public const int ManagedBpfDeletionInvalid = unchecked((int)0x80060383); // -2147089533
		public const int BPFEntityAlreadyExists = unchecked((int)0x80060384); // -2147089532
		public const int MissingControlStep = unchecked((int)0x80060385); // -2147089531
		public const int InvalidUniqueName = unchecked((int)0x80060386); // -2147089530
		public const int ArgumentTypeMismatch = unchecked((int)0x80060387); // -2147089529
		public const int ArgumentDirectionMismatch = unchecked((int)0x80060388); // -2147089528
		public const int InvalidBusinessProcess = unchecked((int)0x80060389); // -2147089527
		public const int UnsupportedActionType = unchecked((int)0x80060390); // -2147089520
		public const int NotExistBusinessProcess = unchecked((int)0x80060391); // -2147089519
		public const int InvalidTaskFlow = unchecked((int)0x80060392); // -2147089518
		public const int NotExistArgumentInAction = unchecked((int)0x80060393); // -2147089517
		public const int UnsupportedArgumentsMarkedRequired = unchecked((int)0x80060394); // -2147089516
		public const int EntityReferenceArgumentsNotBound = unchecked((int)0x80060395); // -2147089515
		public const int NoDefaultValueForOptionSetArgument = unchecked((int)0x80060396); // -2147089514
		public const int BpfInstanceAlreadyExists = unchecked((int)0x80060397); // -2147089513
		public const int ProcessNameContainsInvalidCharacters = unchecked((int)0x80060398); // -2147089512
		...
		public const int CannotDeleteOnlineRecord = unchecked((int)0x8005f248); // -2147093944
		...
		public const int OperationCanceled = unchecked((int)0x80060912); // -2147088110
		public const int SavePending = unchecked((int)0x80060913); // -2147088109
		public const int SchedulingFailedForInvalidData = unchecked((int)0x80060914); // -2147088108
		public const int SchedulingFailedForBookingValidation = unchecked((int)0x80060915); // -2147088107
		...
		public const int MaxprofileItemFilterConditionsAllowed = unchecked((int)0x80071116); // -2147020522
		public const int MobileOfflineRuleEnhancementFeatureNotAvailaible = unchecked((int)0x80071117); // -2147020521
		public const int EmptyEntityFilterXml = unchecked((int)0x80071118); // -2147020520
		public const int QueryFilterConditionAttributeNotPresentInExpressionEntity = unchecked((int)0x80071119); // -2147020519
		public const int LinkedEntitiesAreNotAllowed = unchecked((int)0x80071120); // -2147020512
		public const int UnsupportedOperatorForAttributeInProfileItemEntityFilters = unchecked((int)0x80071121); // -2147020511
		public const int InvalidOrEmptyRelationshipId = unchecked((int)0x80071122); // -2147020510
		public const int UnsupportedAttributeInInProfileItemEntityFilters = unchecked((int)0x80071123); // -2147020509
		...
		public const int MailApp_EmailAddressMismatch = unchecked((int)0x80061211); // -2147085807
		public const int MailApp_UserMailboxInactive = unchecked((int)0x80061216); // -2147085802
		public const int MailApp_MailboxNotConfiguredWithServerSideSyncForACT = unchecked((int)0x80061217); // -2147085801
		public const int MailApp_AppointmentFeatureNotEnabled = unchecked((int)0x80061218); // -2147085800
		...
		public const int TaskFlowNotFound = unchecked((int)0x80061720); // -2147084512
		...
		public const int FeedbackMinMaxRequired = unchecked((int)0x80061772); // -2147084430
		public const int FeedbackRatingValue = unchecked((int)0x80061773); // -2147084429
		public const int FeedbackMinRatingValue = unchecked((int)0x80061774); // -2147084428
		...
		public const int ActionCardDisabledError = unchecked((int)0x80071100); // -2147020544
		public const int ExchangeCardAttributeMissingInResponseException = unchecked((int)0x80071102); // -2147020542
		public const int ActionCardInvalidStateCodeException = unchecked((int)0x80071103); // -2147020541
		public const int ExchangeCardInvalidResponseFormatException = unchecked((int)0x80071104); // -2147020540
		public const int ExchangeCardS2SSetupFailureException = unchecked((int)0x80071105); // -2147020539
		...
		public const int MaxProductsAllowed = unchecked((int)0x80071020); // -2147020768
		public const int NoFilesSelected = unchecked((int)0x80071021); // -2147020767
		public const int DestinationFolderNotExists = unchecked((int)0x80071022); // -2147020766
		public const int NoWritePermission = unchecked((int)0x80071023); // -2147020765
		public const int ConnectionTimeOut = unchecked((int)0x80071024); // -2147020764
		public const int SelectedFileNotFound = unchecked((int)0x80071025); // -2147020763
		public const int FileSizeExceeded = unchecked((int)0x80071026); // -2147020762
		public const int CopyGenericError = unchecked((int)0x80071027); // -2147020761
		public const int RecommendedDocumentsRetrievalFailureWhenSPSiteNotConfigured = unchecked((int)0x80071028); // -2147020760
		...
		public const int InvalidProcessIdOperation = unchecked((int)0x80092001); // -2146885631
		public const int InvalidChangeProcess = unchecked((int)0x80092002); // -2146885630
		public const int InvalidStageTransition = unchecked((int)0x80092003); // -2146885629
		public const int InvalidCrossEntityOperation = unchecked((int)0x80092004); // -2146885628
		public const int InvalidCrossEntityTargetOperation = unchecked((int)0x80092005); // -2146885627
		public const int CrossEntityRelationshipInvalidOperation = unchecked((int)0x80092006); // -2146885626
		public const int InvalidTraversedPath = unchecked((int)0x80092007); // -2146885625
		public const int AutoDataCaptureDisabledError = unchecked((int)0x80091041); // -2146889663
		public const int AutoDataCaptureAuthorizationFailureException = unchecked((int)0x80091042); // -2146889662
		public const int AutoDataCaptureResponseRetrievalFailureException = unchecked((int)0x80091043); // -2146889661
		public const int ProvisioningNotCompleted = unchecked((int)0x80091044); // -2146889660
		public const int PowerBICannotBeSystemDashboard = unchecked((int)0x800608fc); // -2147088132
		public const int PowerBIDashboardControlLimitation = unchecked((int)0x800608fd); // -2147088131
		public const int CannotUpdateEmailStatisticForEmailNotSent = unchecked((int)0x80050001); // -2147155967
		public const int CannotUpdateEmailStatisticForEmailNotFollowed = unchecked((int)0x80050002); // -2147155966
		public const int EmailEngagementFeatureDisabled = unchecked((int)0x80050003); // -2147155965
		public const int OneDriveForBusinessDisabled = unchecked((int)0x80050004); // -2147155964
		public const int InvalidActivityMimeAttachmentId = unchecked((int)0x80050005); // -2147155963
		public const int AttachmentNotRelatedToEmail = unchecked((int)0x80050006); // -2147155962
		public const int EmailDoesNotExist = unchecked((int)0x80050007); // -2147155961
		public const int EmailNotFollowed = unchecked((int)0x80050008); // -2147155960
		public const int OneDriveForBusinessLocationNotFound = unchecked((int)0x80050009); // -2147155959
		public const int DocumentManagementDisabledForEmail = unchecked((int)0x80050010); // -2147155952
		public const int EmailMonitoringNotProvisioned = unchecked((int)0x80050011); // -2147155951
		public const int EmailMonitoringProvisionFailed = unchecked((int)0x80050012); // -2147155950
		public const int ErrorInFetchingEmailEngagementProvisioningStatus = unchecked((int)0x80050013); // -2147155949
		public const int EmailMonitoringDeProvisionFailed = unchecked((int)0x80050014); // -2147155948
		public const int EmailEngagementFeatureDisabledForAttachmentTracking = unchecked((int)0x80050015); // -2147155947
		public const int SiteMapMissing = unchecked((int)0x80050016); // -2147155946
		public const int CannotUpdateTemplateIdForEmailInNonDraftState = unchecked((int)0x80050017); // -2147155945
		public const int CannotUpdateEmailStatisticWhenEEFeatureNotEnabled = unchecked((int)0x80050018); // -2147155944
		public const int InvalidTemplateId = unchecked((int)0x80050019); // -2147155943
		public const int CannotUpdateDelaySendTimeForEmailWhenEmailIsNotInProperState = unchecked((int)0x80050020); // -2147155936
		public const int CannotUpdateDelaySendTimeWhenEEFeatureNotEnabled = unchecked((int)0x80050021); // -2147155935
		public const int DesignerAccessDenied = unchecked((int)0x80050100); // -2147155712
		public const int DesignerInvalidParameter = unchecked((int)0x80050101); // -2147155711
		public const int ErrorTemplate = unchecked((int)0x80050102); // -2147155710
		public const int InvalidAppModuleSiteMap = unchecked((int)0x80050110); // -2147155696
		public const int InvalidMultipleSiteMapReferenceSingleAppModule = unchecked((int)0x80050111); // -2147155695
		public const int InvalidAppModuleComponentType = unchecked((int)0x80050112); // -2147155694
		public const int InvalidAppModuleComponent = unchecked((int)0x80050113); // -2147155693
		public const int CannotPublishAppModule = unchecked((int)0x80050114); // -2147155692
		public const int AppModuleComponentEntityMustHaveFormOrView = unchecked((int)0x80050115); // -2147155691
		public const int InvalidAppModuleId = unchecked((int)0x80050116); // -2147155690
		public const int AppModuleFeatureNotEnabled = unchecked((int)0x80050117); // -2147155689
		public const int AppModuleNotContainMOCAEnabledEntity = unchecked((int)0x80050118); // -2147155688
		public const int CannotUpdateAppModuleUniqueName = unchecked((int)0x80050119); // -2147155687
		public const int InvalidAppModuleUrl = unchecked((int)0x8005011a); // -2147155686
		public const int NoAppModuleComponentReferred = unchecked((int)0x8005011b); // -2147155685
		public const int NoSiteMapReferenceInAppModule = unchecked((int)0x8005011c); // -2147155684
		public const int AppModuleNotReferEntity = unchecked((int)0x8005011d); // -2147155683
		public const int InvalidAppModuleUniqueName = unchecked((int)0x8005011e); // -2147155682
		public const int DuplicateAppModuleUniqueName = unchecked((int)0x8005011f); // -2147155681
		public const int MultipleSitemapsFound = unchecked((int)0x80050120); // -2147155680
		public const int RefferedSolutionIsDifferent = unchecked((int)0x80050122); // -2147155678
		public const int AppModulesImportError = unchecked((int)0x80050123); // -2147155677
